...
La figure \ref{fig:ArIp} montre la section efficace de photoabsorption de l'argon dans la gamme 13.5-16.5 eV. On y voit une série de pics d'absorption en dessous du seuil d'ionisation, qui correspondent à l'excitation d'un électron de valnce vers un état de Rydberg sous le seuil de première ionisation.
