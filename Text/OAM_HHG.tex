...
\subsubsection{Modification du dispositif expérimental}
...
\subsubsection{\'{E}tude du contenu modal du champ par un modèle simple de la GHOE}
...
\textcolor[rgb]{1,0,0}{Figure à rajouter}
